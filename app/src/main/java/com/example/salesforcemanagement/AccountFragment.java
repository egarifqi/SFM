...
public class AccountFragment extends Fragment {
    ...
    private com.example.salesforcemanagement.HistoricalFragment.OnFragmentInteractionListener mListener;
...
//        listViewAdapter.notifyDataSetChanged();
        ...
        dateOfBirthET.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                AppCompatDialogFragment newFragment = new com.example.salesforcemanagement.DatePickerFragment();
        ...
        endDateET.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                AppCompatDialogFragment newFragment = new com.example.salesforcemanagement.DatePickerFragment2();
...
//                listViewAdapter.notifyDataSetChanged();
    ...
    public void onAttach(Context context) {
        ...
        if (context instanceof com.example.salesforcemanagement.HistoricalFragment.OnFragmentInteractionListener) {
            mListener = (com.example.salesforcemanagement.HistoricalFragment.OnFragmentInteractionListener) context;
        } //else {
