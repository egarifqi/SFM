...
import com.example.salesforcemanagement.db.NotesDB;
import com.example.salesforcemanagement.db.NotesDao;
...
import static com.example.salesforcemanagement.EditNoteActivity.NOTE_EXTRA_Key;

public class BrandingActivity extends AppCompatActivity implements NoteEventListener, Drawer.OnDrawerItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbarbranding);
        ...
        // init fab Button
        fab = (FloatingActionButton) findViewById(R.id.fabbranding);
        ...
        SwitchDrawerItem switchDrawerItem = new SwitchDrawerItem()
                ...
                .withOnCheckedChangeListener(new OnCheckedChangeListener() {
                    ...
                    public void onCheckedChanged(IDrawerItem drawerItem, CompoundButton buttonView, boolean isChecked) {
                        ...
                        TaskStackBuilder.create(BrandingActivity.this)
                                .addNextIntent(new Intent(BrandingActivity.this, BrandingActivity.class))
...
//        fab.setVisibility(View.VISIBLE);
    ...
    private void swipeToDelete(final Note swipedNote, final RecyclerView.ViewHolder viewHolder) {
        new AlertDialog.Builder(BrandingActivity.this)
