...
//        tabLayout.addTab(tabLayout.newTab().setText("TUGAS HARI INI"));
        ...
        final com.example.salesforcemanagement.DashboardPagerAdapter adapter = new com.example.salesforcemanagement.DashboardPagerAdapter(getSupportFragmentManager(), tabLayout.getTabCount());
