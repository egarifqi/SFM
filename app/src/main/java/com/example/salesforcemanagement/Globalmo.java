...
public class Globalmo {

    public static ArrayList<com.example.salesforcemanagement.Spacecraft> produk = new ArrayList<com.example.salesforcemanagement.Spacecraft>();
    ...
    public static String brand = "brand:Make Over";
