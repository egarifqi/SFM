...
//        tabLayout.addTab(tabLayout.newTab().setText("ADDITIONAL ORDER"));
        ...
        final com.example.salesforcemanagement.HistoricalSalesWardahPagerAdapter adapter = new com.example.salesforcemanagement.HistoricalSalesWardahPagerAdapter(getSupportFragmentManager(), tabLayout.getTabCount());
