...
import com.example.salesforcemanagement.adapters.NotesAdapter;
import com.example.salesforcemanagement.adapters.NotesAdapterlisting;
import com.example.salesforcemanagement.callbacks.MainActionModeCallback;
...
import com.example.salesforcemanagement.db.NotesDBlisting;
import com.example.salesforcemanagement.db.NotesDaolisting;
...
import static com.example.salesforcemanagement.EditNotelistingActivity.NOTE_EXTRA_Key;

public class ListingFeeActivity extends AppCompatActivity implements NoteEventListenerlisting, Drawer.OnDrawerItemClickListener {
    private static final String TAG = "MainActivity";
    private RecyclerView recyclerView;
    private ArrayList<Notelisting> notes;
    private NotesAdapterlisting adapter;
    private NotesDaolisting dao;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_listing_fee);
        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbarlisting);
        setSupportActionBar(toolbar);

        setupNavigation(savedInstanceState, toolbar);
        // init recyclerView
        recyclerView = findViewById(R.id.notes_listlisting);
        recyclerView.setLayoutManager(new LinearLayoutManager(this));

        // init fab Button
        fab = (FloatingActionButton) findViewById(R.id.fablisting);
        ...
        dao = NotesDBlisting.getInstance(this).notesDao();
    }
        ...
        SwitchDrawerItem switchDrawerItem = new SwitchDrawerItem()
                ...
                .withOnCheckedChangeListener(new OnCheckedChangeListener() {
                    ...
                    public void onCheckedChanged(IDrawerItem drawerItem, CompoundButton buttonView, boolean isChecked) {
                        ...
                        TaskStackBuilder.create(ListingFeeActivity.this)
                                .addNextIntent(new Intent(ListingFeeActivity.this, ListingFeeActivity.class))
    ...
    private void loadNotes() {
        ...
        List<Notelisting> list = dao.getNotes();// get All notes from DataBase
        this.notes.addAll(list);
        this.adapter = new NotesAdapterlisting(this, this.notes);
    ...
    private void onAddNewNote() {
        startActivity(new Intent(this, EditNotelistingActivity.class));
    ...
    private void onShareNote() {
        ...
        Notelisting notelisting = adapter.getCheckedNotes().get(0);
        // TODO: 22/07/2018 do your logic here to share note ; on social or something else
        Intent share = new Intent(Intent.ACTION_SEND);
        share.setType("text/plain");
        String notetext = notelisting.getNoteText() + "\n\n Create on : " +
                NoteUtils.dateFromLong(notelisting.getNoteDate()) + "\n  By :" +
    ...
    private void onDeleteMultiNotes() {
        ...
        List<Notelisting> chackedNotes = adapter.getCheckedNotes();
        if (chackedNotes.size() != 0) {
            for (Notelisting note : chackedNotes) {
                dao.deleteNote(note);
            }
            // refresh Notes
            loadNotes();
...
//        fab.setVisibility(View.VISIBLE);
    ...
    private ItemTouchHelper swipeToDeleteHelper = new ItemTouchHelper(
            new ItemTouchHelper.SimpleCallback(0, ItemTouchHelper.LEFT | ItemTouchHelper.RIGHT) {
                ...
                public void onSwiped(RecyclerView.ViewHolder viewHolder, int direction) {
                    ...
                    if (notes != null) {
                        // get swiped note
                        Notelisting swipedNote = notes.get(viewHolder.getAdapterPosition());
                        if (swipedNote != null) {
    ...
    private void swipeToDelete(final Notelisting swipedNote, final RecyclerView.ViewHolder viewHolder) {
        new AlertDialog.Builder(ListingFeeActivity.this)
    ...
    @Override
    public void onNoteClick(Notelisting note) {
    ...
    @Override
    public void onNoteLongClick(Notelisting note) {
// TODO: 22/07/2018 note long clicked : delete , share ..
        ...
        adapter.setListener(new NoteEventListenerlisting() {
            @Override
            public void onNoteClick(Notelisting note) {
