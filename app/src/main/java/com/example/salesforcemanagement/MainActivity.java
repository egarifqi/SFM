                ...
                if (cancel) {
                    ...
                    for (int j = 0; j < username.size(); j++) {
                        if (emailET.equals(username.get(j)) && pwET.equals(password.get(j))) {
                            ...
                            com.example.salesforcemanagement.StatusSR.idSR = salesacc;
...
//                            Spacecraft s = new Spacecraft();
                            com.example.salesforcemanagement.TokoDalamRute tdr = new com.example.salesforcemanagement.TokoDalamRute();
                            try {
...
//                                    downloadedData.add(s);
                                ...
                                com.example.salesforcemanagement.StatusSR.callPlan = response.length();
...
//                            Toast.makeText(getBaseContext(), "UNSUCCESSFUL :  ERROR IS : " + anError.getMessage(), Toast.LENGTH_LONG).show();
        ...
        protected void onPostExecute(String s) {
            ...
            Intent intent = new Intent(MainActivity.this, com.example.salesforcemanagement.VisitActivity.class);
