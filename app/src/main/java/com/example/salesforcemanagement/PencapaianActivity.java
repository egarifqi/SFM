...
public class PencapaianActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        callTV.setText(String.valueOf(com.example.salesforcemanagement.StatusSR.totalCall));
        callplanTV.setText(String.valueOf(com.example.salesforcemanagement.StatusSR.callPlan));
        ecTV.setText(String.valueOf(com.example.salesforcemanagement.StatusSR.totalEC));
        notecTV.setText(String.valueOf(com.example.salesforcemanagement.StatusSR.totalNotEC));
        Locale localeID = new Locale("in", "ID");
        NumberFormat formatRP = NumberFormat.getCurrencyInstance(localeID);
        penjualanTV.setText(formatRP.format(com.example.salesforcemanagement.StatusSR.totalOrder));
