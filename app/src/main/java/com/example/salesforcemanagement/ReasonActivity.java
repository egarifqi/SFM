...
public class ReasonActivity extends AppCompatActivity {
    ...
    private Button sendalasan;
    private Spinner spinnertunda;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TabLayout tabLayout = findViewById(R.id.tab_layoutreason);

        tabLayout.addTab(tabLayout.newTab().setText("Alasan Tunda Toko"));
        sendalasan = findViewById(R.id.save_gambartunda);
        spinnertunda = findViewById(R.id.spinner_tunda);
        ...
        sendalasan.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (netInfo != null && netInfo.isConnected()){
                    ...
                    status = spinnertunda.getSelectedItem().toString();
                    Log.e("alasan", status);

                    Intent intent = new Intent(ReasonActivity.this, KunjunganActivity.class);
                    ...
                    com.example.salesforcemanagement.StatusToko.statuskunjungan.add("1");
...
//                    Toast.makeText(getBaseContext(), "Anda tidak terhubung ke internet!!\nPastikan anda mendapatkan sinyal internet yang memadai sebelum memilih tombol KIRIM...", Toast.LENGTH_LONG).show();
                    AlertDialog.Builder dialog = new AlertDialog.Builder(ReasonActivity.this);
    ...
    public void pilihAlasan(View view) {
        TextView alasan = findViewById(R.id.tampil_alasantunda);
        Spinner spinner = findViewById(R.id.spinner_tunda);
