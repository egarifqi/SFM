...
public class ReasonNotECActivitty extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        editorToko = prefToko.edit();com.example.salesforcemanagement.StatusToko.kodetoko.add(prefToko.getString("partner_name", ""));
                        com.example.salesforcemanagement.StatusToko.namatoko.add(prefToko.getString("ref", ""));
        ...
        sendalasannotec.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (netInfo != null && netInfo.isConnected()){
                    final String status;
                    boolean dalamrute = prefToko.getBoolean("dalamrute", com.example.salesforcemanagement.StatusToko.rute);
                    boolean luarrute = prefToko.getBoolean("luarrute", !com.example.salesforcemanagement.StatusToko.rute);
                    ...
                    if (status.equals("Not EC: Force Major") || status.equals("Not EC: Toko Tutup dan Tuan Toko Tidak Konfirmasi")) {
                        ...
                        com.example.salesforcemanagement.StatusToko.kodetoko.add(prefToko.getString("partner_name", ""));
                        com.example.salesforcemanagement.StatusToko.namatoko.add(prefToko.getString("ref", ""));
                        com.example.salesforcemanagement.StatusToko.statuskunjungan.add("2");
                        com.example.salesforcemanagement.StatusToko.totalamount.add(0);
                        com.example.salesforcemanagement.StatusToko.totalqty.add(0);
                        com.example.salesforcemanagement.StatusToko.totalsku.add(0);
...
//                                ",\n SKU : " + com.example.sfmtesting.StatusToko.totalsku.get(com.example.sfmtesting.StatusToko.getCount() - 1));
                        if (dalamrute && !luarrute) {
                            ...
                            editor.putInt("calldr", com.example.salesforcemanagement.StatusSR.dalamRute);
                            editor.putInt("necdr", com.example.salesforcemanagement.StatusSR.ECdalamRute);
                            editor.commit();
                        } else if (!dalamrute && luarrute) {
                            com.example.salesforcemanagement.StatusSR.luarRute += 1;
                            editor.putInt("calllr", com.example.salesforcemanagement.StatusSR.dalamRute);
                            editor.commit();
                        }
                        com.example.salesforcemanagement.StatusSR.totalCall += 1;
                        com.example.salesforcemanagement.StatusSR.subtotal = 0;
                        ...
                        Intent intent = new Intent(ReasonNotECActivitty.this, com.example.salesforcemanagement.TakingOrderBrandActivity.class);
