...
public class HistoricalSalesMOActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_historical_sales_mo);
        androidx.appcompat.widget.Toolbar toolbar = findViewById(R.id.toolbarhistmo);
...
//        tabLayout.addTab(tabLayout.newTab().setText("ADDITIONAL ORDER"));
        ...
        final ViewPager viewPager = findViewById(R.id.pagerhistoricalsalesmo);
        final com.example.sfmtesting.HistoricalSalesMOPagerAdapter adapter = new com.example.sfmtesting.HistoricalSalesMOPagerAdapter(getSupportFragmentManager(), tabLayout.getTabCount());
